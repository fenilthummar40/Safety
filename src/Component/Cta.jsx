        ...
        <section className="py-20 bg-[#0b0b0f] text-white relative overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto px-6 text-center relative">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                    <button
                        className="flex items-center justify-center gap-2 bg-orange-500 text-black px-8 py-4 rounded-xl text-lg font-semibold hover:bg-orange-600 hover:scale-105 transition shadow-[0_0_30px_rgba(255,165,0,0.3)] cursor-pointer">Start
                        Today <IconArrowRight size={20}/>
                    </button>

                    <Link to='/Signup'>
                        <button
                            className="flex items-center justify-center gap-2 border border-white/20 px-8 py-4 rounded-xl text-lg font-semibold text-gray-300 hover:bg-white/10 transition cursor-pointer">Sign Up <IconUserPlus size={20}/>
                        </button>
                    </Link>
                </div>
